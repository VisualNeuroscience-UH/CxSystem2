...
function readSingleFile(e) {
    ...
    reader.onload = function (e) {
        ...
        if (Object.keys(imported_data).includes('physio_data')) { // this means it's a physio file
            ...
            clearBox('physio_holder');
            physio_editor = new JSONEditor(document.getElementById('physio_holder'), {
                ajax: true,
            ...
            for (var key in imported_data) {
                ...
                switch (key) {
                    case "params":
                        ...
                        clearBox('params_holder');
                        params_editor = new JSONEditor(document.getElementById('params_holder'), {
                            ajax: true,
                    ...
                    case "IN":
                        ...
                        clearBox('inputs_holder')
                        inputs_editor = new JSONEditor(document.getElementById('inputs_holder'), {
                            ajax: true,
                    ...
                    case "G":
                        ...
                        clearBox('neurons_holder')
                        neurons_editor = new JSONEditor(document.getElementById('neurons_holder'), {
                            ajax: true,
                    ...
                    case "S":
                        ...
                        clearBox('connections_holder')
                        connections_editor = new JSONEditor(document.getElementById('connections_holder'), {
                            ajax: true,
