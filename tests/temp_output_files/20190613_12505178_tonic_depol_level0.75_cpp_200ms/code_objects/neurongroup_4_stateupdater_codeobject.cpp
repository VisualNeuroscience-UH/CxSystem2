...
void _run_neurongroup_4_stateupdater_codeobject()
{
	...
	///// CONSTANTS ///////////
	const int _numnot_refractory = 32;
const int _numt = 1;
const int _numlastspike = 32;
const int _numgi_soma = 32;
const int _numge_soma = 32;
const int _numvm = 32;
const int _numdt = 1;
	///// POINTERS ////////////
 ...
 double* __restrict  _ptr_array_neurongroup_4_vm = _array_neurongroup_4_vm;
 ...
 const double _lio_3 = 1.0f*((0.002 * 3.0266169453e-09) * exp(1.0f*(- (- 0.054635702226600004))/0.002))/7.152214852749999e-11;
 const double _lio_4 = 1.0f*1.0/0.002;
 const double _lio_5 = 1.0f*((- 0.0724306544604) * 3.0266169453e-09)/7.152214852749999e-11;
 const double _lio_6 = 1.0f*0.0/7.152214852749999e-11;
 const double _lio_7 = 1.0f*(- 0.075)/7.152214852749999e-11;
 const double _lio_8 = 1.0f*3.6000000000000005e-11/7.152214852749999e-11;
 const double _lio_9 = 1.0f*3.0266169453e-09/7.152214852749999e-11;
 const double _lio_10 = 1.0f*1.0/7.152214852749999e-11;
 const double _lio_11 = 1.0f*(3.6000000000000005e-11 * exp(1.0f*((- 0.02) * t)/0.001))/7.152214852749999e-11;
 const double _lio_12 = 0.0 * (_brian_pow(0.02363105401843664, - 0.5));
 ...
 const double _lio_15 = 1.0f*(- dt)/0.0083;
	...
	for(int _idx=0; _idx<_N; _idx++)
	{
        ...
        double gi_soma = _ptr_array_neurongroup_4_gi_soma[_idx];
        double ge_soma = _ptr_array_neurongroup_4_ge_soma[_idx];
        double vm = _ptr_array_neurongroup_4_vm[_idx];
        ...
        ge_soma = _ge_soma;
        gi_soma = _gi_soma;
        _ptr_array_neurongroup_4_gi_soma[_idx] = gi_soma;
        _ptr_array_neurongroup_4_ge_soma[_idx] = ge_soma;
        _ptr_array_neurongroup_4_vm[_idx] = vm;
        _ptr_array_neurongroup_4_not_refractory[_idx] = not_refractory;

	}

    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    neurongroup_4_stateupdater_codeobject_profiling_info += _run_time;
}
