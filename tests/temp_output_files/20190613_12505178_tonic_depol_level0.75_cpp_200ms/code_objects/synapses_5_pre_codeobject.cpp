...
double* const _array_synapses_5_wght = _dynamic_array_synapses_5_wght.empty()? 0 : &_dynamic_array_synapses_5_wght[0];
const int _numwght = _dynamic_array_synapses_5_wght.size();
...
double* const _array_synapses_5_R = _dynamic_array_synapses_5_R.empty()? 0 : &_dynamic_array_synapses_5_R[0];
const int _numR = _dynamic_array_synapses_5_R.size();
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_5__synaptic_post.size();
 ...
 double* __restrict  _ptr_array_synapses_5_wght = _array_synapses_5_wght;
 double* __restrict  _ptr_array_synapses_5_lastupdate = _array_synapses_5_lastupdate;
 double* __restrict  _ptr_array_synapses_5_R = _array_synapses_5_R;
 ...
 const double _lio_2 = 1.0 - 0.5;
   ...
   const double wght = _ptr_array_synapses_5_wght[_idx];
   double lastupdate = _ptr_array_synapses_5_lastupdate[_idx];
   double R = _ptr_array_synapses_5_R[_idx];
   ...
   _ptr_array_synapses_5_R[_idx] = R;
