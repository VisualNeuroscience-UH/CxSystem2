...
void _run_synapses_34_pre_push_spikes()
{
    ...
    {
        synapses_34_pre.advance();
        synapses_34_pre.push(_ptr_array_neurongroup_3__spikespace, _ptr_array_neurongroup_3__spikespace[_num_spikespace-1]);
    }

    // Profiling
    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    synapses_34_pre_push_spikes_profiling_info += _run_time;
}
