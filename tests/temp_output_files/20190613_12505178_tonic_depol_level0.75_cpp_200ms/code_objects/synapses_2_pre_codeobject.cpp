...
double* const _array_synapses_2_R = _dynamic_array_synapses_2_R.empty()? 0 : &_dynamic_array_synapses_2_R[0];
const int _numR = _dynamic_array_synapses_2_R.size();
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_2__synaptic_post.size();
 ...
 double* __restrict  _ptr_array_synapses_2_R = _array_synapses_2_R;
 ...
 const double _lio_2 = 1.0 - 0.5;
   ...
   double R = _ptr_array_synapses_2_R[_idx];
   ...
   _ptr_array_synapses_2_R[_idx] = R;
