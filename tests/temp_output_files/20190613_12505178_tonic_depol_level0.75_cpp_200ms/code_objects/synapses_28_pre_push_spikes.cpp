...
void _run_synapses_28_pre_push_spikes()
{
    ...
    {
        synapses_28_pre.advance();
        synapses_28_pre.push(_ptr_array_neurongroup_2__spikespace, _ptr_array_neurongroup_2__spikespace[_num_spikespace-1]);
    }

    // Profiling
    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    synapses_28_pre_push_spikes_profiling_info += _run_time;
}
