...
const int _num_source_idx = 40;
 ...
 int32_t* __restrict  _ptr_array_spikemonitor_3__source_idx = _array_spikemonitor_3__source_idx;
    ...
    spikemonitor_3_codeobject_profiling_info += _run_time;
}
