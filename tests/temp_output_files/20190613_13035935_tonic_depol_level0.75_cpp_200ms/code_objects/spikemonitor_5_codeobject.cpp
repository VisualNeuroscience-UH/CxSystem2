...
const int _numt = _dynamic_array_spikemonitor_5_t.size();
...
const int _numi = _dynamic_array_spikemonitor_5_i.size();
const int _num_spikespace = 14;
const int _num_source_i = 13;
const int _num_source_idx = 13;
	///// POINTERS ////////////
 ...
 int32_t* __restrict  _ptr_array_spikemonitor_5__source_idx = _array_spikemonitor_5__source_idx;
    ...
    spikemonitor_5_codeobject_profiling_info += _run_time;
}
