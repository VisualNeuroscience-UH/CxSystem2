...
double* const _array_synapses_1_R = _dynamic_array_synapses_1_R.empty()? 0 : &_dynamic_array_synapses_1_R[0];
const int _numR = _dynamic_array_synapses_1_R.size();
const int _numt = 1;
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_1__synaptic_post.size();
 ...
 double* __restrict  _ptr_array_synapses_1_R = _array_synapses_1_R;
 ...
 const double _lio_2 = 1.0 - 0.5;
   ...
   double R = _ptr_array_synapses_1_R[_idx];
   ...
   _ptr_array_synapses_1_R[_idx] = R;
